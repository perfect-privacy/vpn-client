...
if not os.path.exists(APP_VAR_DIR):         os.mkdir(APP_VAR_DIR)
if not os.path.exists(SOFTWARE_UPDATE_DIR): os.mkdir(SOFTWARE_UPDATE_DIR)
if not os.path.exists(CONFIG_UPDATE_DIR):   os.mkdir(CONFIG_UPDATE_DIR)
