...
class Settings_wlan_accesspoint(PyHtmlView):
    TEMPLATE_STR = '''
    ...
    def __init__(self, subject, parent, on_back, **kwargs):
        """
        :type subject: core.settings.settings.Settings_WlanAccesspoint
        :type parent: gui.privacypi.components.settings.settings.Settings
        :type on_back: function
        """
        super(Settings_wlan_accesspoint, self).__init__(subject, parent)
